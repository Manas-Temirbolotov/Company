...
employees_router.register('position', employees_views.PositionViewSet)
...
urlpatterns = [
    ...
    # path('api/position', employees_views.PositionViewSet.as_view()),
    # path('api/position/<int:pk>/', employees_views.PositionViewSet.as_view()),
    path('api/employees', employees_views.EmployeesListCreateAPIView.as_view()),
    path('api/employees/<int:pk>/', employees_views.EmployeesRetrieveUpdateDestroyAPIView.as_view()),
